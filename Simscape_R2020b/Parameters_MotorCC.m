...
tau_m = 0.098;      % Constante de tiempo mecánica
...
R_total = 9.77;         % Resistencia total del potenciómetro en kOhms  

ZM_pot = 17.5;          % Zona muerta del potenciómetro en grados

Right_pot = 360-ZM_pot/2; % Entrada para el cursor en el puerto R

Left_pot = ZM_pot/2;    % Entrada para el cursor en el puerto L

Theta_reductora = 180;  % Ángulo inicial de la reductora en grados

offset_pot = 4;         % Desfase entre potenciómetro y reductora
