...
smiData.RigidTransform(4).axis = [-1 -4.3898412872550639e-32 1.4684210648011499e-16];
...
smiData.RevoluteJoint(1).Rz.Pos = 52.367912529018284;  % deg
smiData.RevoluteJoint(1).ID = "[Base-2:-:Eje_Sinfin_Encoder-3]";

smiData.RevoluteJoint(2).Rz.Pos = 52.319918710340346;  % deg
