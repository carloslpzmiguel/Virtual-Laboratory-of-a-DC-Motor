...
theta_tornillo_env = mod(1/K_reductora * Theta_reductora, 360);

% Inicialización de ángulos - tornillo sinfín y corona
smiData.RevoluteJoint(1).Rz.Pos = theta_tornillo_env;  % deg
smiData.RevoluteJoint(1).ID = "[Base-2:-:Eje_Sinfin_Encoder-3]";

smiData.RevoluteJoint(2).Rz.Pos = Theta_reductora;  % deg
